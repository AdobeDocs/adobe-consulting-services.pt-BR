...
O conteúdo e os metadados do AEM são sincronizados do AEM para a VPN quando o fluxo de trabalho de integração é acionado. Isso pode ser feito automática ou manualmente. Os metadados de VPM são sincronizados do VPM para o AEM. Isso pode ser feito automaticamente por meio de um scheduler ou manualmente por meio de um clique de botão.
...
* Embora a integração seja compatível com o conteúdo modular do AEM (fragmentos de conteúdo e fragmentos de experiência), ela não é compatível com o conteúdo modular do VPM.
* Não há suporte para documentos vinculados ao VPM.
* Não há suporte para a sincronização de anotações visuais do VPM com o AEM.
