...
Agradecemos sua colaboração com a documentação dos Serviços de consultoria da Adobe. As contribuições de conteúdo são bem-vindas de toda a nossa comunidade de leitores, bem como de outros funcionários da Adobe.
...
Embora qualquer contribuição para aprimorar a documentação do AEM seja bem-vinda, pedimos que as contribuições sigam algumas diretrizes e normas sempre que possível. Revise o [Diretrizes para contribuir com a documentação do ACS](guidelines.md) para obter mais informações.
